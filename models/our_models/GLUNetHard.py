...
class GLUNet_model(nn.Module):
    ...
    def __init__(self, evaluation, div=1.0, iterative_refinement=False,
        ...
        if pyramid_type == 'ResNet':
        ...
        elif pyramid_type == 'HardNet':
            self.pyramid = HardNetPyramid()
        elif pyramid_type == 'HardNet2':
            ...
            self.pyramid = HardNetPyramidNoRELU()
        elif pyramid_type == 'VGG':
            self.pyramid = VGGPyramid()
        else:
            raise ValueError("Unknown Pyramid type")
